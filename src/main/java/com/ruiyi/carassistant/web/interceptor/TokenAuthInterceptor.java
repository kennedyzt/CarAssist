package com.ruiyi.carassistant.web.interceptor;
...
import com.ruiyi.carassistant.utils.AuthUtil;
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response,
        ...
        if (handler instanceof HandlerMethod) {
            ...
            if (token != null) {
                ...
                if (userID != null && !userID.trim().equals("") && tokenStr != null && !tokenStr.trim().equals("") && AuthUtil.isValidated(userID,tokenStr)) {
                    return true;
                } else {
